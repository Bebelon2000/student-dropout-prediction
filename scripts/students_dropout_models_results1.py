...
def read_dataset(filename):
    columns_to_keep = ["Relocated","HasDebt","PayTuition","Gender","HasScholarship","X2","X4","X5","X8","X9","X10","X11","Dropout"]
...
def present_model_results(dataset_filename, scaler_filename):
    ...
    present_results('KNN', 'models/knn_students_dropout_less_correl.pkl', x, t)
    present_results('SVM', 'models/svm_students_dropout_less_correl.pkl', x, t)
    present_results('Random forest', 'models/rf_students_dropout_less_correl.pkl', x, t)
