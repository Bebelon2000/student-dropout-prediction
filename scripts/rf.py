...
joblib.dump(rf, 'models/rf_students_dropout_less_correl.pkl')
...
display_confusion_matrix(t_train, y_train, classes, "RF training data confusion matrix")
display_confusion_matrix(t_test, y_test, classes, " RF test data confusion matrix")